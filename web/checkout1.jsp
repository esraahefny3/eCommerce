<%-- 
    Document   : checkout1
    Created on : Feb 6, 2018, 7:50:41 PM
    Author     : Nehal
--%>
        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-9" id="checkout">
                    ...
                    <div class="box">
                        <form method="post" action="./reviewCart">
                            <h1>Checkout</h1>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Address</label>
                                            <textArea required style="width:600px;height:100px;resize: none;" class="form-control" name="addressArea"><c:out value="${sessionScope.user.getAddress()}"/></textarea>
                                            </div> 
                                    </div>
